...
03.01.1998 	new lexicon version
06.01.1998  bug in syllable border placement caused wrong accentuation -
            fixed different boundary strengths can be adjusted, new default value new version of the lexicon
22.01.1998 	bug in preprocessing, new version of the lexicon
24.02.1998 	new version of the lexicon, correction in spelling routine
06.03.1998 	new version of the lexicon
04.05.1998 	minor revisions
03.07.1998 	duration network included, 'R@R' error fixed, new version of the lexicon
04.07.1998 	severe bug in compound analysis fixed
14.07.1998 	new intonation model, reduction level externalized
15.07.1998 	version number in program
14.08.1998 	fixed all storage leaks, tested by processing 1,2M words
18.08.1998 	switched to standard transcription SAMPA, standard input ANSI
30.08.1998 	fixed bug in rule transcription, new version of lexicon
10.09.1998 	fixed a bug in duration network, enabled SPEECHRATE in config file
15.09.1998 	included decision tree duration control, fixed bug in word prosody module
20.09.1998 	bug in lexicon lookup fixed, new lexicon
21.11.1998 	some bugs, new lexicon, better number support
08.01.1999 	a large number of bugfixes, new lexicon
24.01.1999 	other bugfixes, proper command line support, CART prominence computation
27.01.1999 	rc file included
12.03.1999 	several fixes, small changes, {Comment}-feature
19.05.1999 	some minor fixes
01.06.1999 	fixed some severe errors
