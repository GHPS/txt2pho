...
Parameter und jener mit den Abkürzungen als zweitem Parameter übergeben werden:
...
Üblicherweise wird die Ausgabe von preproc wird als pipe nach txt2pho weitergeleitet:
#+BEGIN_SRC sh
