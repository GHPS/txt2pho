...
- [[https://github.com/GHPS/txt2pho/tree/master/examples/example1.wav][Text "Ein Test für Sprachausgabe in Deutsch"]]
- [[https://github.com/GHPS/txt2pho/tree/master/examples/example2.wav][Friedrich Schiller "Die Glocke"]]
