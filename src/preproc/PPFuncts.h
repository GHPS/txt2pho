...
extern char* dnumeral(char* in) ;
extern char* dnumeral_range(char* in) ;
extern char* fraction(char* in) ;
extern char* ratio(char* in) ;
extern char* thousands_separated_number(char* in) ;
extern char* countnumber(char* in) ;
...
extern char* number_mixture(char* in) ;
