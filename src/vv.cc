...
//						fprintf(result," . ") ;
            ...
            if (strchr(".,?!;:", buffer[i]) != NULL)
            {
                ...
                {
                    case '.' :
                        satzzeichen = (char*)"; Punkt## " ;
                        break ;
                    case ',' :
                        satzzeichen = (char*)"; Komma## " ;
                        break ;
                    case '?' :
                        satzzeichen = (char*)"; Fragezeichen## " ;
                        break ;
                    case '!' :
                        satzzeichen = (char*)"; Ausrufezeichen## " ;
                        break ;
                    case ';' :
                        satzzeichen = (char*)"; Semikolon## " ;
                        break ;
                    case ':' :
                        satzzeichen = (char*)"; Doppelpunkt## " ;
                        break ;
                }
                switch (buffer[i])
                {
