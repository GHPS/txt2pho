...
char upper_char (char c)
{
    ...
    switch (c)
    {
        case '_':
            return ' ';
        case asc_a_acc_acute:
            return asc_A_acc_acute;
        case asc_a_acc_grave:
            return asc_A_acc_grave;
        case asc_a_acc_hat:
            return asc_A_acc_hat;
        case asc_a_umlaut:
            return asc_A_umlaut;
        case asc_e_acc_acute:
            return asc_E_acc_acute;
        case asc_e_acc_grave:
            return asc_E_acc_grave;
        case asc_e_acc_hat:
            return asc_E_acc_hat;
        case asc_o_acc_acute:
            return asc_O_acc_acute;
        case asc_o_acc_grave:
            return asc_O_acc_grave;
        case asc_o_acc_hat:
            return asc_O_acc_hat;
        case asc_o_umlaut:
            return asc_O_umlaut;
        case asc_u_acc_acute:
            return asc_U_acc_acute;
        case asc_u_acc_grave:
            return asc_U_acc_grave;
        case asc_u_acc_hat:
            return asc_U_acc_hat;
        case asc_u_umlaut:
            return asc_U_umlaut;
        case asc_n_tilde:
            return asc_N_tilde;
