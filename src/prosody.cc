...
//      fflush(errfile) ;
    ...
    for (i=0 ; i < syll.soundnr ; i++)
    {
        ...
        else if (plosivdur == 0 && strchr("ptkb_dg?", s->name[0]) != NULL)
        {
            ds = dsl.find_sound(s->name) ;
...
//				fprintf(errfile,"made to %f %f %f %f\n",i.delay,i.amplitude,i.betali,i.betare) ;
                ...
                else if (strcmp(syll.prosinfo, "H") == 0)
                {
                    i.t0 = actms ;
                ...
                else if (strcmp(syll.prosinfo, "N") == 0)
                {
                    i.t0 = actms ;
                ...
                else if (strcmp(syll.prosinfo, "FHe") == 0)
                {
                    i.t0 = actms ;
                    i.amplitude = 0.8 ;
                ...
                else if (strcmp(syll.prosinfo, "EHe") == 0)
                {
                    if (focus == 1 && syll.accent < 28)
                        syll.accent -=15 ;
                    i.t0 = actms ;
                ...
                else if (strcmp(syll.prosinfo, "EHw") == 0)
                {
                    i.t0 = actms ;
                    i.amplitude = 0.5 ;
...
//			fprintf(errfile,"made to %f %f %f %f\n",i.delay,i.amplitude,i.betali,i.betare) ;
                ...
                #endif
            else if (strcmp(syll.type, "PGR") == 0 && nnfile != NULL)
            {
                if (onlystress == 0)
                    fgets(buffer, 299, nnfile) ;
                #ifndef LOWBORDERTONE
